...
interface IRepository
{
    ...
    public function orderBy(string $order,int $limit, string $sortby): ?object;
...
abstract class BaseRepository implements IRepository
{
    ...
    public function orderBy(string $order = 'asc',int $limit = self::LIMIT,

    string $sortby = 'name'): ?object
    {
        return $this->model = $this->model->orderBy($sortby,$order)->limit($limit)->get();
